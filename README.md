...
|:----------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------:|
| ![Android Demo](docs/android_setting_page.gif) | <img src="docs/android_img.webp" height="250" alt="Android Demo2"> | <img src="docs/android_setting.webp" height="250" alt="Android Demo3"> | 
