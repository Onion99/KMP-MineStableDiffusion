...
| Android                               | Desktop      |
|---------------------------------------|--------------|
| ![android_screenshot_3.gif](docs/android_screenshot_3.gif) | ![desktop_screenshot.gif](docs/desktop_screenshot.gif) |
...
> [!NOTE]
> If using Android device, it must be Android 11 or above
